...
import { User, Mail, Building, Calendar, BadgeCheck, Phone, Globe, X, Edit2, Lock } from "lucide-react";
    ...
    <div className="p-4 md:p-8 space-y-4 md:space-y-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">Your reviewer profile information.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        >
          ...
          <h2 className="text-xl font-bold text-slate-900">{user?.name || "Reviewer"}</h2>
          <p className="text-sm text-slate-500 mt-1">{user?.email}</p>
          <div className="mt-3">
            <span className="px-3 py-1 rounded-full text-xs font-bold border bg-blue-50 text-blue-600 border-blue-100">
              {user?.role}
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-900 font-medium mt-0.5">{profile?.expertise || "—"}</p>
              </div>
            </div>
